...
const db = mysql.createConnection({
    ...
    host: '87yiie.h.filess.io',
    port: 61002,
    user: 'C237database_wavemotion',
    password: '80617532f6fe37e0f170af0288a9b7801b9e10f3',
    database: 'C237database_wavemotion'
});
...
const validateRegistration = (req, res, next) => {
    ...
    next(); // if all validations pass, the next function is called, allowing the request 
...
app.get('/login', (req, res) => {
    res.render('login', {
        messages: req.flash('success'), // Retrieve success messages from rhe session and pass them to the view
